      ...
      <?php
        ...
        if (mysqli_num_rows($res) > 0) {
            while($row = mysqli_fetch_assoc($res)) {
                ...
                $posts .= "<div class='container'><h2 class='flow-text'><a href='blogpost.php?pid=$id'>$title</a></h2><p class='flow-text'>$output</p><p class='flow-text'>posted by $username on $date</p></div>$admin";
            }
            echo $posts;
        } else {
